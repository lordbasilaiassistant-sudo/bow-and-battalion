...
const GRADES = [
  { id:'slots',  name:'ARMY SLOTS',    icon:'plate', base:110, mul:1.29, max:40, unit:'+1 SLOT',
    desc:'Field more soldiers at once. Every unit occupies slots equal to its weight.' },
  { id:'drill',  name:'INFANTRY DRILL',icon:'helm',  base:150, mul:1.30, endless:true, unit:'+15% HP · +16% DMG · +6% SPD · +8% ATK SPD',
    desc:'Endless. Drill your infantry harder every rank — health and damage climb forever; march + attack speed cap at rank 14. Swordsmen, shieldmen, berserkers, knights, archers, musketeers and crews.' },
  { id:'plating',name:'ARMOR PLATING', icon:'tank',  base:260, mul:1.31, endless:true, unit:'+16% HP · +17% DMG · +6% SPD · +8% RELOAD',
    desc:'Endless. Weld more plate, better engines and optics every rank — vehicle health and damage climb forever; speed + reload cap at rank 14.' },
  { id:'walls',  name:'CURTAIN WALL',  icon:'gate',  base:180, mul:1.29, endless:true, unit:'+11% FORTRESS HP',
    desc:'Endless. Thicker stone, deeper foundations, forever. Also fully repairs the wall on purchase.' },
  { id:'purse',  name:'WAR CHEST',     icon:'coin',  base:190, mul:1.33, endless:true, unit:'+11% GOLD',
    desc:'Endless. Better looting and cleaner books, rank after rank — more gold from every corpse, every level, and a fatter war-tax every second.' },
  { id:'lab',    name:'FIELD LABORATORY',icon:'flask',base:300, mul:1.45, max:14, unit:'+1 RESEARCH / LEVEL',
    desc:'Camp scholars dissect enemy wreckage between engagements. More research per level cleared.' },
  { id:'hospital',name:'FIELD HOSPITAL', icon:'heart', base:220, mul:1.30, endless:true, unit:'+20% HEALING',
    desc:'Endless. Better salves and cleaner blades, forever. Chirurgeons and every healing effect mend harder.' },
  { id:'conduit', name:'ARCANE CONDUITS',icon:'orb',   base:260, mul:1.31, endless:true, unit:'+15% MAGE DAMAGE',
    desc:'Endless. Channel deeper leylines every rank. Pyromancer flame and Stormcaller lightning strike harder without limit.' },
  { id:'siege',   name:'SIEGECRAFT',     icon:'ram',   base:240, mul:1.30, endless:true, unit:'+12% WALL DAMAGE',
    desc:'Endless. School the whole army in breaking stone, forever. Every source you own hits castles harder.' },
  { id:'merc',    name:'MERCENARY BANNERS',icon:'coin', base:360, mul:1.27, endless:true, unit:'+3% ALL-ARMY HP & DMG',
    desc:'Endless. When the armouries are full, coin still talks — hire sellswords and pay your veterans to fight harder. Every banner costs more than the last, so a deep war chest never goes to waste.' },
];
